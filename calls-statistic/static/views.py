...
# queryset_calls = Activity.objects.filter(
#             RESPONSIBLE_ID__UF_DEPARTMENT__in=[50],
#             RESPONSIBLE_ID__ACTIVE=True,
#             RESPONSIBLE_ID__STATUS_DISPLAY=True,
#             CREATED__year=2022,
#             TYPE_ID=2,
#             DIRECTION=2,
#             phone__CALL_DURATION__gte=20,
#             active=True
#         ).distinct(
#             'CREATED__month', 'CREATED__day', 'COMPANY_ID'
#         ).values_list(
...
#
# def f2():
#     # queryset = Activity.objects.select_related('phone').annotate(
#     #     DURATION=models.F("phone__CALL_DURATION"),
#     #     # DAY=models.functions.Extract("CREATED", "day")
#     # ).filter(
#     #     # RESPONSIBLE_ID__UF_DEPARTMENT=50,
#     #     # RESPONSIBLE_ID__ACTIVE=True,
#     #     # RESPONSIBLE_ID__STATUS_DISPLAY=True
#     # ).filter(
#     #     # Q(DURATION__gte=20),
...
#     #     "RESPONSIBLE_ID", 'CREATED__month'
#     # )
#     queryset = Activity.objects.select_related('phone').select_related('RESPONSIBLE_ID').filter(
#                     CREATED__year=2022,
#                     TYPE_ID=2,
#                     DIRECTION=2,
#                     # phone__CALL_DURATION__gte=20,
...
#                 ).annotate(
#                     respons=models.F("RESPONSIBLE_ID")
#                 ).annotate(
...
#
#     users = {}
#     for user_id, month_num in queryset:
#         if user_id not in users:
#             users[user_id] = {}
#         if month_num not in users[user_id]:
#             users[user_id][month_num] = 1
#         else:
#             users[user_id][month_num] += 1
#
#     pprint.pprint(users[4333])
#     print(len(queryset))
#
#
# def f2():
...
#     ).distinct(
#         'CREATED__month', 'CREATED__day', 'COMPANY_ID'
#     ).values_list("RESPONSIBLE_ID", 'CREATED__month').order_by("CREATED__month", 'CREATED__day', 'COMPANY_ID', "RESPONSIBLE_ID")
#     query = Counter(queryset)
#     # pprint.pprint(query)
#     # print(len(queryset))
#     users = {}
#     for obj in queryset:
...
#         phone__CALL_DURATION__gte=20,
#     ).annotate(
#         dur=models.F("phone__CALL_DURATION")
#     )
...
#         item.save()
#     print(len(queryset))
#     queryset.DURATION = models.F('phone__CALL_DURATION')
#     queryset.save()
#
#
# def f5():
...
#     # ?CALL_DURATION = 20 & CREATED_after = 2022 - 3 - 1 & CREATED_before = 2022 - 3 - 31 & RESPONSIBLE_ID = 184 & limit = 100 & offset = 300
#
#
# def f6():
#     queryset = Activity.objects.annotate(
...
#         active=True
#     ).distinct(
#         'CREATED__month', 'CREATED__day', 'COMPANY_ID', 'RESPONSIBLE_ID'
#     ).values_list("RESPONSIBLE_ID", 'CREATED__month').order_by("CREATED__month", 'CREATED__day', 'COMPANY_ID', "RESPONSIBLE_ID")
#     query = Counter(queryset)
#     pprint.pprint(query)
#     # print(len(queryset))
...
#     # pprint.pprint(query)
#     users = {}
#     for (user_id, month_num), count in query.items():
#         # user_id = obj.respons
#         # month_num = obj.MONTH
#         if user_id not in users:
#             users[user_id] = {}
